...
def main():
    ...
    if args.format == "nt":
        write_graph_ntriples_lines(graph, str(tmp_full_path), append=args.append)
    else:
        write_graph_turtle_lines(graph, str(tmp_full_path), include_prefixes=not args.append, append=args.append)
